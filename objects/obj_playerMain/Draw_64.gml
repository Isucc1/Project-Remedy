...
if instance_exists(obj_fade){
	draw_set_alpha(1 - obj_fade.alpha)
	_alpha = 1 - obj_fade.alpha
}

if global.roomType != "Serious" || global.roomType != "Cutscene"{
	for (var i = 0; i < unlockedClasses + 1; ++i) {
	    draw_sprite_ext(array_get(sprites[i], 2), 0, 344 - (i * 16), 16, 1, 1, 0, c_white, _alpha)
	}
}
...
if global.roomType == "Combat"{
		...
		if canDodge{
			draw_sprite(spr_dash, 0, 344, 208)
		} else draw_sprite_ext(spr_dash, 0, 344, 208, 1, 1, 0, c_white, 0.5)
